...
const AUDIO_PATH = '/Users/edycu/Projects/DemoStudio/public/projects/Shipmate/demo_audio.mp3';

async function runDemo() {
  console.log('🚀 Starting Shipmate Demo Recording Script...');
  ...
  if (videoPath) {
    const finalPath = path.join('/Users/edycu/Projects/DemoStudio/public/projects/Shipmate', 'Shipmate_Demo.webm');
