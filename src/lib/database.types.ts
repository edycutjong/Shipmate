 ...
 * Only covers Shipmate tables. Conforms to the GenericSchema shape
  ...
  public: {
    Tables: {
      shipmate_sweeps: {
        ...
        Relationships: [
          {
            foreignKeyName: "shipmate_logs_sweep_id_fkey";
            columns: ["id"];
            isOneToOne: false;
            referencedRelation: "shipmate_logs";
        ...
        Relationships: [
          {
            ...
            columns: ["sweep_id"];
            isOneToOne: false;
            referencedRelation: "shipmate_sweeps";
